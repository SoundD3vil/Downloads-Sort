This script is a PowerShell solution that helps to automatically sort files in the download folder into different subfolders. The script is easy to use and can be customized to meet the user's needs.
Requirements
